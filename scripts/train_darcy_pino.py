...
from neuralop.datasets.darcy import load_darcy_421_5k
...
pipe = ConfigPipeline(
    [
        YamlConfig(
            "./darcy_pino_config.yaml", config_name="default", config_folder="../config"
        ),
...
train_loader, _, test_loaders, data_processor = load_darcy_421_5k(
    ...
    encode_input=True,
    encode_output=True,
    data_path="/home/dpitt/work/data/darcy/darcy_421_5000/darcy_5k.pt"
)
